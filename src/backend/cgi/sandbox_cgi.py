...
# Common error: "[Sun Jun 03 13:18:14.345457 2018] [cgi:error] [pid 22240] [client 132.66.1.18:61229] End of script output before headers: PASA_cgi.py"
...
sys.path.append('/bioseq/pasa/auxiliaries')
...
results_url = os.path.join(CONSTS.PASA_RESULTS_URL, run_number)
output_url = os.path.join(results_url, CONSTS.RESULT_WEBPAGE_NAME)

wd = os.path.join(CONSTS.PASA_RESULTS_DIR, run_number)
create_dir(wd)
